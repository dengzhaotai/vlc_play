 ...
 * Original file: F:\\android2014.07.24\\workspace\\VlcAudioLib\\src\\org\\videolan\\vlc\\interfaces\\IAudioService.aidl
 */
...
case TRANSACTION_loadMediaList:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
boolean _arg2;
_arg2 = (0!=data.readInt());
this.loadMediaList(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
...
@Override public void loadMediaList(int position, boolean libvlcBacked, boolean noVideo) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeInt(((noVideo)?(1):(0)));
mRemote.transact(Stub.TRANSACTION_loadMediaList, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_loadMediaList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_append = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_moveItem = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_remove = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_removeLocation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
...
public void loadMediaList(int position, boolean libvlcBacked, boolean noVideo) throws android.os.RemoteException;
/**add 2014.08.09*/
